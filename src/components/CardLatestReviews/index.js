              ...
              <tbody>
                {cars.map((car) => (
                  <tr>
                    <td>
                      <CRow>
                        <CCol md="3" className="pr-0">
                          <img src={car.image} className="rectangle" />
                        </CCol>
                        <CCol className="pl-0 car-info">
                      ...
                      <CRow>
                        <CCol className="car-info-three">
                          ...
                          <div className="date-info">
                            <span className="s-1435">18/05/2020 às 14:35</span>
                          </div>
                        </CCol>
                      </CRow>
                    </td>
        ...
        <CRow>
          <CCol>
            <a href="#" className="ver-tudo">
              Ver tudo
              <img src={icArrowDown} className="ic_arrow_drop_down" />
            </a>
          </CCol>
        </CRow>
      </CCardFooter>
